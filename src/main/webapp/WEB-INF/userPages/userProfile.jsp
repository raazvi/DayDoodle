            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    ...
                    <c:forEach var="notification" items="${unreadNotifications}">
                        <a href="${pageContext.request.contextPath}/ViewNotification?notificationId=${notification.id}" class="list-group-item list-group-item-action list-group-item-warning">
                    ...
                    <c:forEach var="notification" items="${readNotifications}">
                        <a href="${pageContext.request.contextPath}/ViewNotification?notificationId=${notification.id}" class="list-group-item list-group-item-action">
                                ${notification.message} <br> <small>${notification.formattedCreatedAt}</small>
                        </a>
                    </c:forEach>
